  ...
  const generateListing = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://hook.eu2.make.com/cp27r1ulmyagsgyakaf5l5tixdye0x7e",
        {
          method: "POST",
          headers: {
      ...
      if (typeof data === "string" || data.listing) {
        onGenerated(typeof data === "string" ? data : data.listing);
        onSuccess();
      } else {
      ...
      setError(
        err instanceof Error
          ? err.message
          : "An error occurred while generating the listing"
      );
    } finally {
      setIsLoading(false);
    }
    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-gray-600 mb-8">
          Our AI will analyze your property details and create a compelling
          listing that highlights its best features.
        </p>
